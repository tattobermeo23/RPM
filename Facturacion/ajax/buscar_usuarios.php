	...
	if($action == 'ajax'){
		...
		if ($numrows>0){
			...
			<div class="table-responsive">
			  <table class="table">
				<tr  class="info">
					<th style="background-color: #ffd185">ID</th>
					<th style="background-color: #ffd185">Nombres</th>
					<th style="background-color: #ffd185">Usuario</th>
					<th style="background-color: #ffd185">Email</th>
					<th style="background-color: #ffd185">Agregado</th>
					<th style="background-color: #ffd185"><span class="pull-right">Acciones</span></th>
