	...
	if($action == 'ajax'){
		...
		if ($numrows>0){
			...
			<div class="table-responsive">
			  <table class="table">
				<tr  class="info">
					<th style="background-color: #ffd185">#</th>
					<th style="background-color: #ffd185">Fecha</th>
					<th style="background-color: #ffd185">Cliente</th>
					<th style="background-color: #ffd185">Vendedor</th>
					<th style="background-color: #ffd185">Estado</th>
					<th style="background-color: #ffd185" class='text-right'>Total</th>
