	...
	if($action == 'ajax'){
		...
		if ($numrows>0){
			...
			<div class="table-responsive">
			  <table class="table" >
				<tr  class="info" style="background-color: orange" >
					<th style="background-color: #ffd185">Nombre</th>
					<th style="background-color: #ffd185">Teléfono</th>
					<th style="background-color: #ffd185">Email</th>
					<th style="background-color: #ffd185">Dirección</th>
					<th style="background-color: #ffd185">Estado</th>
					<th style="background-color: #ffd185">Agregado</th>
					<th style="background-color: #ffd185" class='text-right'>Acciones</th>
