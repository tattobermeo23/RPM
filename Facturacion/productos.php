    ...
    <div class="container">
		...
		<div class="panel-heading">
			<div class="btn-group pull-right">
					<button style="background-color:orange; border:orange;" type='button' class="btn btn-info" data-toggle="modal" data-target="#nuevoProducto"><span class="glyphicon glyphicon-plus" ></span> Nuevo Producto</button>
			</div>
