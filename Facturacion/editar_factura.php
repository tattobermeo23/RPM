...
<html lang="en">
  ...
  <body>
	...
	<div class="panel panel-info">
		<div tyle="background-color:black; color:white;" class="panel-heading">
			<h4 tyle="background-color:black; color:white;"><i class='glyphicon glyphicon-edit'></i> Editar Factura</h4>
		</div>
